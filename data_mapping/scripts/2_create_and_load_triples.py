...
query_path = os.path.join("data_mapping", "sparql", "query.sparql")
output_query_results = os.path.join("data_mapping", "results.csv")
...
subprocess.run(["docker", "run", 
                ...
                "--reasoner", "elk",
                "--axiom-generators", '"SubClass EquivalentClass ClassAssertion PropertyAssertion EquivalentObjectProperty SubObjectProperty"',
