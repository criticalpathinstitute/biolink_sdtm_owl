 ...
 * [biolink_sdtm_owl.yml](biolink_sdtm_owl.yml)
     * Determines how your purl.obolibrary.org/obo/biolink_sdtm_owl/ redirects will be handled
     ...
     * Paste in the contents of [biolink_sdtm_owl.yml](biolink_sdtm_owl.yml)
 ...
 * [biolink_sdtm_owl.md](biolink_sdtm_owl.md)
     ...
     * Paste in the contents of [biolink_sdtm_owl.md](biolink_sdtm_owl.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
